...
# =============================================================================
#种群初始化-使用以前的种群
#pop = func.pop_inherit(n, c, NP, Path)  #初始化种群
...
#    logs_path = r"./logs/motif_SOSFCD/zhang/zhang_Qc_log.txt"
...
#            f.write(str(bestQ))
#        ## 更新最优解    
#        pop_best_history_path = r"result/motif_SOSFCD/zhang/pop_best_Qc_history.txt"
#        fit_best_history_path = r"result/motif_SOSFCD/zhang/fit_best_Qc_history.txt"
