...
#    if len(set(bestX_membership)) == 3:
    logs_path = r"./logs/motif_SOSFCD/football/football_Q_log.txt"
    ...
    run += 1
    # 保存目前n次的独立实验中的最优值
    bestQ_path = r"./paras/motif_SOSFCD/football/bestQ.txt"
    flag = 0
    ...
    if flag == 1:
        ...
        with open(bestQ_path, mode='w',encoding='UTF-8') as f:
            f.write(str(bestQ))
        ## 更新最优解    
        pop_best_history_path = r"result/motif_SOSFCD/football/pop_best_Q_history.txt"
        fit_best_history_path = r"result/motif_SOSFCD/football/fit_best_Q_history.txt"
        nmi_path = r"result/motif_SOSFCD/football/NMI_Q_history.txt"
