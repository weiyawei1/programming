...
static double __pyx_f_15cython_function_fit_Qg(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_15cython_function_fit_Qg(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_adj, int __pyx_v_n, int __pyx_v_c, int __pyx_v_W, __Pyx_memviewslice __pyx_v_m); /* proto */
...
static double __pyx_f_15cython_function_fit_Qg(__Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_adj, int __pyx_v_n, int __pyx_v_c, int __pyx_v_W, __Pyx_memviewslice __pyx_v_m, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_Qg;
  int __pyx_v_k;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 */
        ...
        __pyx_t_16 = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_m.data + __pyx_t_12 * __pyx_v_m.strides[0]) ) + __pyx_t_13 * __pyx_v_m.strides[1]) ))) * (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_m.data + __pyx_t_14 * __pyx_v_m.strides[0]) ) + __pyx_t_15 * __pyx_v_m.strides[1]) )))) * 1.0);
...
static PyObject *__pyx_pw_15cython_function_1fit_Qg(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("fit_Qg (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_adj)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("fit_Qg", 1, 6, 6, 1); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fit_Qg", 1, 6, 6, 2); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fit_Qg", 1, 6, 6, 3); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_W)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fit_Qg", 1, 6, 6, 4); __PYX_ERR(0, 24, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_m)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fit_Qg", 1, 6, 6, 5); __PYX_ERR(0, 24, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fit_Qg") < 0)) __PYX_ERR(0, 24, __pyx_L3_error)
      }
    ...
    __pyx_v_adj = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_adj.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_n = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_c == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_W = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_W == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_m = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_m.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fit_Qg", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 24, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_15cython_function_fit_Qg(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_adj, int __pyx_v_n, int __pyx_v_c, int __pyx_v_W, __Pyx_memviewslice __pyx_v_m) {
  ...
  if (unlikely(!__pyx_v_adj.memview)) { __Pyx_RaiseUnboundLocalError("adj"); __PYX_ERR(0, 24, __pyx_L1_error) }
  if (unlikely(!__pyx_v_m.memview)) { __Pyx_RaiseUnboundLocalError("m"); __PYX_ERR(0, 24, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_15cython_function_fit_Qg(__pyx_v_X, __pyx_v_adj, __pyx_v_n, __pyx_v_c, __pyx_v_W, __pyx_v_m, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
