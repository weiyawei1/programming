...
bestQ_path = r"./paras/motif_SOSFCD/zhang/bestQc.txt"
flag = 0
...
if flag == 1:
    ...
    with open(bestQ_path, mode='w',encoding='UTF-8') as f:
        f.write(str(bestQ))
    ## 更新最优解    
    pop_best_history_path = r"result/motif_SOSFCD/zhang/Qc_pop_best_history.txt"
    fit_best_history_path = r"result/motif_SOSFCD/zhang/Qc_fit_best_history.txt"
    nmi_path = r"result/motif_SOSFCD/zhang/NMI_Qc_history.txt"
    try:
